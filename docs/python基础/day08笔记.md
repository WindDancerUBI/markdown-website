 ...
 * @Date: 2025-05-08 09:51:10
 * @LastEditors: huangjitao 164173925@qq.com
 * @LastEditTime: 2025-05-08 09:51:11
 * @Description: 
-->
## 1、异常介绍
...
<img src="/img/python基础/8/img/image-20220521144746376.png" alt="image-20220521144746376"  />

方法二：在工程目录中右键---new---Directory--在新创建的目录中再创建一个`__init__.py`文件。

<img src="/img/python基础/8/img/image-20220521144816423.png" alt="image-20220521144816423" />
